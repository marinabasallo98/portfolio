        ...
        <section id="about" className="p-10 scroll-mt-16">
            ...
            <div className="mb-16 flex flex-col lg:flex-row gap-10">
                <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li>Lenguajes: HTML, CSS, JavaScript, TypeScript, Java, PHP, SQL</li>
                        <li>Frameworks y librerías: Laravel, Angular, Tailwind CSS</li>
                        <li>Gestión de bases de datos: MySQL</li>
                        <li>Control de versiones: Git, GitHub</li>
                        <li>Herramientas: VS Code, Adobe Creative Suite, Office Suite, herramientas CAT y de subtitulado</li>
                    </ul>
                </div>
                ...
                <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li>Desarrolladora Web - NTTData (Oct 2025 - Dic 2025)</li>
                        <li>Traductora y coordinadora de subtítulos - Autónoma (2023)</li>
                        <li>Gestora de Proyectos de Traducción - TransPerfect (2021-2025)</li>
                        <li>Auxiliar de Organización de Eventos Lúdicos - EventosGO (2019-2023)</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="mb-16 flex flex-col lg:flex-row gap-10">
                <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        <li>Grado Superior de Desarrollo Web - IES Zaidín Vergeles (2023-2025)</li>
                        <li>Máster en Traducción Audiovisual - ISTRAD y Universidad de Cádiz (2020-2021)</li>
                        <li>Grado en Traducción e Interpretación - Universidad de Granada (2016-2020)</li>
                    </ul>
                </div>
                ...
                <div className="flex-1">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>Inglés - C1-C2</li>
                        <li>Chino Simplificado - B2 (HSK4)</li>
                    </ul>
                </div>
            </div>
        </section>
